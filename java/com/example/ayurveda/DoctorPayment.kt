...
class DoctorPayment : AppCompatActivity() {
    ...
    private val file = "patientdata.txt"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b1 = findViewById(R.id.saveinfo)
        ed1 = findViewById(R.id.ppNumberPayment)
        ed2 = findViewById(R.id.pAddressPayment)
        ed3 = findViewById(R.id.pNamepayment)

        b1.setOnClickListener {
            data1 = ed1.text.toString()
            data2 = ed2.text.toString()
            data3 = ed3.text.toString()
            try {
